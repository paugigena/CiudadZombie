...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/bache.png', 320, 150, 30, 30, 1 ),
    new Obstaculo('imagenes/bache.png', 170, 190, 30, 30, 1 ),
    new Obstaculo('imagenes/bache.png', 780, 400, 30, 30, 1 ),
    new Obstaculo('imagenes/auto_verde_abajo.png', 70, 280, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 420, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 350, 420, 30, 15, 2)
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 290, 230, 10, 10, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie1.png', 890, 530, 10, 10, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png', 400, 650, 10, 10, 3, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie3.png', 750, 150, 10, 10, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png', 520, 490, 10, 10, 3, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie4.png', 610, 380, 10, 10, 4, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie4.png', 320, 260, 10, 10, 4, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    //conductores
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 3, {desdeX: 0, hastaX: 871, desdeY: 0, hastaY: 577},'h' ),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 150, 30, 90, 5, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 480},'v' ),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 8, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 480},'v' )
...
//linea de llegada
 for (let i = 0; i <= 12; i++) {
    for (let j = 0; j < 3; j++) {
      if (i % 2 != 0) {
        if (j % 2 == 0) {
          Dibujante.dibujarRectangulo('white', 760 + i * 10, 500 + j * 10, 10, 10);
        }
      }
      if (i % 2 == 0) {
        if (j % 2 != 0) {
